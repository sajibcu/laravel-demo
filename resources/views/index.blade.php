...
<body>
  ...
  <div class="masthead mb-5">
    <div class="nsbd_slider stick-dots">
      <div class="nsbd_slide">
        <div class="nsbd_slide__img">
          <img src="" alt="" data-lazy="resources/images/banner-new-3.jpg" class="full-image animated"
            data-animation-in="zoomInImage" />
        </div>
        <div class="nsbd_slide__content">
          <div class="nsbd_slide__content--headings">
            <h2 class="animated" data-animation-in="fadeInUp">EMERGING STUDY</h2>
            <p class="animated" data-animation-in="fadeInUp" data-delay-in="0.3">Immersive learning experience</p>
          </div>
        </div>
      </div>
      <div class="nsbd_slide">
        <div class="nsbd_slide__img">
          <img src="" alt="" data-lazy="resources/images/banner-new-2.jpg" class="full-image animated"
            data-animation-in="zoomInImage" />
        </div>
        <div class="nsbd_slide__content">
          <div class="nsbd_slide__content--headings">
            <h2 class="animated" data-animation-in="fadeInRight">EMERGING STUDY</h2>
            <p class="animated" data-animation-in="fadeInRight" data-delay-in="0.2">Immersive learning experience</p>
          </div>
        </div>
      </div>
    </div>
  ...
  <div class="container">
    <div class="row text-center">
      <h1 class="course_title">Classes</h1>
    </div>
    <div class="row">
      ...
      <div class="col-md-4 col-sm-6">
        <div class="serviceBox green-color">
          <div class="service-icon">
            K
          </div>
          <div class="service-content">
      ...
      <div class="col-md-4 col-sm-6">
        <div class="serviceBox orange-color">
          <div class="service-icon">
            1
          </div>
          <div class="service-content">
            <h3><a href="">First Grade</a></h3>
            <p>
      ...
      <div class="col-md-4 col-sm-6">
        <div class="serviceBox pink-color">
          <div class="service-icon">
            2
          </div>
          <div class="service-content">
            <h3><a href="">Second Grade</a></h3>
            <p>
      ...
      <div class="col-md-4 col-sm-6">
        <div class="serviceBox blue-color">
          <div class="service-icon">
            3
          </div>
          <div class="service-content">
            <h3><a href="">Third Grade</a></h3>
            <p>
      ...
      <div class="col-md-4 col-sm-6">
        <div class="serviceBox red-color">
          <div class="service-icon">
            4
          </div>
          <div class="service-content">
            <h3><a href="">Fourth Grade</a></h3>
            <p>
      ...
      <div class="col-md-4 col-sm-6">
        <div class="serviceBox yellow-color">
          <div class="service-icon">
            5
          </div>
          <div class="service-content">
            <h3><a href="">Fifth Grade</a></h3>
            <p>
      ...
      <div class="col-md-4 col-sm-6">
        <div class="serviceBox purple-color">
          ...
          <div class="service-content">
            <h3><a href="">Seventh Grade</a></h3>
            <p>
              Proportional relationships, phrases and clauses, connotations, climate change, world history, and more.
            </p>
          </div>
        </div>
      </div>
      ...
      <div class="col-md-4 col-sm-6">
        <div class="serviceBox yellow-color">
          ...
          <div class="service-content">
            <h3><a href="">Ninth Grade</a></h3>
            <p>
              Quadratic equations, scatter plots, exponents, parallel language, figures of speech, semicolons, and more.
            </p>
          </div>
        </div>
      </div>
